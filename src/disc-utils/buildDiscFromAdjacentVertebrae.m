...
%   discMesh : struct with triangulation + metadata
    ...
    % ------------------------------------------------------------
    supDiscEnd = extractEndplate(supVertMesh, "inferior", pct); % extracting 'inferior' side of 'superior' vertebra --> 'superior' disc endplate
    infDiscEnd = extractEndplate(infVertMesh, "superior", pct); % extracting 'superior' side of 'inferior' vertebra --> 'inferior' disc endplate
