function [indSup, dummyFigure] = findSuperiorSurface(ns, Pt, plane, model, makeplot, showQuivers, dummyFigure)
    % Finds the index of the superior surface index location, indSup, by 
    ...
    for sl = ns:-1:1
        ...
        if makeplot
            ...
            if sl == ns
                ...
                title("(Superior surface search) 3D polyshape for layer: " + sl)
